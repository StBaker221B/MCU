...
void runDecide()
{
    ...
    {
        // RUN
        if((USART_RX_BUF[0] == 0x52) && (USART_RX_BUF[1] == 0x55)
            && (USART_RX_BUF[2] == 0x4E))
        {
            rs = RUN;
            // init();
        ...
        // PAUSE 
        else if((USART_RX_BUF[0] == 0x50) && (USART_RX_BUF[1] == 0x41)
            && (USART_RX_BUF[2] == 0x55))
        {
            rs = PAUSE;
            TIM3_Pause();
        ...
        // OFF 
        else if((USART_RX_BUF[0] == 0x4F) && (USART_RX_BUF[1] == 0x46)
            && (USART_RX_BUF[2] == 0x46))
        {
            rs = OFF;
            TIM3_Pause();
